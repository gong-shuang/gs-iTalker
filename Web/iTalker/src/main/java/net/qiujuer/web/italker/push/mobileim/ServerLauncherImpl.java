package net.qiujuer.web.italker.push.mobileim;
...
//		BridgeProcessor.IMMQ_URI = "amqp://js:19844713@192.168.31.190";
    ...
    {
        // ** 设置各种回调事件处理实现类
        this.setServerEventListener(new ServerEventListenerImpl());   //event的监听，
        this.setServerMessageQoSEventListener(new MessageQoSEventS2CListnerImpl());
    }

    //服务端的IM代码
    public static void serverLauncherMain() throws Exception
    {
