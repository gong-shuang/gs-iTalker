...
/**
 * 这个是会话的Activity，就是具体的，和某人（群）聊天的界面。
 */
public class MessageActivity extends Activity {
     ...
     */
    public static void show(Context context, Session session, Fragment fragment) {
...
//        context.startActivity(intent);
        fragment.startActivityForResult(intent, USER);
    }
    ...
    protected void initWidget() {
        ...
        Fragment fragment;
        if (mIsGroup)
            fragment = new ChatGroupFragment();   //是群聊天
        else
            fragment = new ChatUserFragment();    //是个人聊天
