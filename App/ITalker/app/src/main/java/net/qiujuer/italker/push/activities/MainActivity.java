...
import net.qiujuer.italker.push.frags.main.MeFragment;
...
public class MainActivity extends Activity
    ...
    protected void initWidget() {
        ...
        mNavHelper.add(R.id.action_home, new NavHelper.Tab<>(ActiveFragment.class, R.string.title_home))
                ...
                .add(R.id.action_me, new NavHelper.Tab<>(MeFragment.class, R.string.title_me));
    ...
    /**
     * NavHelper 处理后回调的方法，就是底部的导航栏切换完成后的回调
     *
     * @param newTab 新的Tab
     * @param oldTab 就的Tab
     */
